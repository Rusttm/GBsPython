...
input_frame = Frame(root, width = 312, height = 50, bd = 0, highlightbackground = "grey", highlightcolor = "blue", highlightthickness = 0)
...
btns_frame = Frame(root, width = 312, height = 272.5, bg = "white")
btns_frame.pack()
